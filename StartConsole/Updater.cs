...
namespace StartConsole
{
	public class Updater
	{
		...
		private void Start()
		{
			StreamWriter w = new StreamWriter(File.Create("MCFrog_Update_Batch.bat"));
			{
			...
			System.Diagnostics.Process.Start(Directory.GetCurrentDirectory() + "\\MCFrog_Update_Batch.bat");
		}
	}
}
